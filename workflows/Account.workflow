...
&quot;&lt;b&gt;&lt;font color=&apos;blue&apos; size=&apos;3&apos;&gt; *** &quot; &amp;  SalesAsOfHidden__c  &amp; &quot; ***&lt;/font&gt;&lt;/b&gt;&quot;)</formula>
    ...
    <rules>
        ...
        <formula>AND(ISCHANGED( PerformanceImprovement__c ) ,    OR (ISPICKVAL(PerformanceImprovement__c, &quot;Product Improvement&quot;),  ISPICKVAL(PerformanceImprovement__c, &quot;Account Improvement&quot;), ISPICKVAL(PerformanceImprovement__c, &quot;SFDC ECM Kickoff&quot;)))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
