...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <formula>AND ( EndDate  &lt; TODAY(),  OR( ISPICKVAL(BCS_Univar_Status__c, &quot;Executed&quot;), ISPICKVAL(BCS_Univar_Status__c, &quot;Cancelled&quot; ), ISPICKVAL(BCS_Univar_Status__c, &quot;Pending Signature&quot;), ISPICKVAL(BCS_Univar_Status__c, &quot;NDA Signed&quot;)))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
