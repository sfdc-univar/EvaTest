...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <formula>AND (OR(CONTAINS(Product__r.Name,&quot;Silicone&quot; ), CONTAINS(Product_Description__c, &quot;Silicone&quot;)),  OR(Annual_LBs__c &gt;= 500000, Amount &gt;= 250000 ),  NOT(ISPICKVAL( StageName , &quot;Closed Won&quot;)),  NOT(ISPICKVAL( StageName , &quot;Closed Lost&quot;)))</formula>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND(OR(CONTAINS(Product__r.Name,&quot;Silicone&quot; ), CONTAINS(Product_Description__c, &quot;Silicone&quot;)),  OR(Annual_LBs__c &gt;= 500000, Amount &gt;= 250000 ),  ISPICKVAL( StageName , &quot;Closed Won&quot;))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND  (OR(Product__r.Name = &quot;Glycol Ether EB&quot;,Product__r.Name = &quot;Isopropyl Alcohol&quot;,Product__r.Name = &quot;Methyl Ethyl Ketone&quot;,Product__r.Name = &quot;Acetone&quot;,Product__r.Name = &quot;Toluene&quot;, Product__r.Name = &quot;Xylene&quot;,  CONTAINS(Product_Description__c, &quot;Glycol Ether EB&quot;),  CONTAINS(Product_Description__c, &quot;IPA&quot;),  CONTAINS(Product_Description__c, &quot;Isopropyl Alcohol&quot;),  CONTAINS(Product_Description__c, &quot;MEK&quot;),  CONTAINS(Product_Description__c, &quot;Methyl Ethyl Ketone&quot;),  CONTAINS(Product_Description__c, &quot;Acetone&quot;),  CONTAINS(Product_Description__c, &quot;Toluene&quot;),  CONTAINS(Product_Description__c, &quot;Xylene&quot;)),  OR(Annual_LBs__c &gt;= 500000, Amount &gt;= 250000 ),  NOT(ISPICKVAL( StageName , &quot;Closed Won&quot;)),  NOT(ISPICKVAL( StageName , &quot;Closed Lost&quot;)))</formula>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND (OR(Product__r.Name  = &quot;Glycol Ether EB&quot;,Product__r.Name  = &quot;Isopropyl Alcohol&quot;,Product__r.Name  = &quot;Methyl Ethyl Ketone&quot;,Product__r.Name  = &quot;Acetone&quot;,Product__r.Name  = &quot;Toluene&quot;, Product__r.Name  = &quot;Xylene&quot;,  CONTAINS(Product_Description__c, &quot;Glycol Ether EB&quot;), CONTAINS(Product_Description__c, &quot;IPA&quot;), CONTAINS(Product_Description__c, &quot;Isopropyl Alcohol&quot;), CONTAINS(Product_Description__c, &quot;MEK&quot;), CONTAINS(Product_Description__c, &quot;Methyl Ethyl Ketone&quot;), CONTAINS(Product_Description__c, &quot;Acetone&quot;), CONTAINS(Product_Description__c, &quot;Toluene&quot;),  CONTAINS(Product_Description__c, &quot;Xylene&quot;)), NOT( CONTAINS(Product_Description__c, &quot;DIPA&quot;)),  NOT( CONTAINS(Product_Description__c, &quot;MIPA&quot;)),  OR(Annual_LBs__c  &gt;= 500000, Amount  &gt;= 250000 ),   (ISPICKVAL( StageName, &quot;Closed Won&quot;)))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND  (OR(Product__r.Name = &quot;Ethylene Glycol&quot;,Product__r.Name = &quot;Diethylene Glycol&quot;,  CONTAINS(Product_Description__c, &quot;Ethylene Glycol&quot;),  CONTAINS(Product_Description__c, &quot;Diethylene Glycol&quot;),  CONTAINS(Product_Description__c, &quot;DEG&quot;)),  Amount &gt;= 200000,  NOT(ISPICKVAL( StageName , &quot;Closed Won&quot;)),  NOT(ISPICKVAL( StageName , &quot;Closed Lost&quot;)))</formula>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND  (OR(Product__r.Name = &quot;Ethylene Glycol&quot;,Product__r.Name = &quot;Diethylene Glycol&quot;,  CONTAINS(Product_Description__c, &quot;Ethylene Glycol&quot;),  CONTAINS(Product_Description__c, &quot;Diethylene Glycol&quot;),  CONTAINS(Product_Description__c, &quot;DEG&quot;)),  Amount &gt;= 200000,  ISPICKVAL( StageName , &quot;Closed Won&quot;))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND  (OR(Product__r.Name = &quot;Propylene Glycol-USP&quot;,Product__r.Name = &quot;Propylene Glycol-Indust&quot;,  CONTAINS(Product_Description__c, &quot;Propylene Glycol&quot;),  CONTAINS(Product_Description__c, &quot;PG&quot;),  CONTAINS(Product_Description__c, &quot;PGUSP&quot;),  CONTAINS(Product_Description__c, &quot;PGI&quot;)),  Amount &gt;= 400000,  NOT(ISPICKVAL( StageName , &quot;Closed Won&quot;)),  NOT(ISPICKVAL( StageName , &quot;Closed Lost&quot;)))</formula>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND  (OR(Product__r.Name = &quot;Propylene Glycol-USP&quot;,Product__r.Name = &quot;Propylene Glycol-Indust&quot;,  CONTAINS(Product_Description__c, &quot;Propylene Glycol&quot;),  CONTAINS(Product_Description__c, &quot;PG&quot;),  CONTAINS(Product_Description__c, &quot;PGUSP&quot;),  CONTAINS(Product_Description__c, &quot;PGI&quot;)),  Amount &gt;= 400000,  ISPICKVAL( StageName , &quot;Closed Won&quot;))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
