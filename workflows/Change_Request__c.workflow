...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <formula>AND  (AND(ISPICKVAL(Approval_Project_Sponsors__c , &quot;Approve&quot;),     OR(ISCHANGED( Approval_Project_Sponsors__c),  ISNEW() )),   ISPICKVAL(  Assigned_To__c ,&quot;&quot;), ISBLANK( Deployment__c ), NOT(ISPICKVAL( Change_Request_Status__c ,&quot;Cancelled&quot;)), NOT(ISPICKVAL( Change_Request_Status__c ,&quot;Completed&quot;)))</formula>
